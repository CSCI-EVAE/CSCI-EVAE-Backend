...
public class EvaluationServiceImpl implements EvaluationService {
    ...
    @Autowired
    public EvaluationServiceImpl(EvaluationRepository er, PromotionRepository promotionRepository, UniteEnseignementRepository uniteEnseignementRepository, EvaluationMapper evaluationMapper, ElementConstitutifRepository elementConstitutifRepository, RubriqueEvaluationService rubriqueEvaluationService) {
        this.er = er;
    ...
    public EvaluationDTO getEvaluationById(Long id) throws ChangeSetPersister.NotFoundException {
        ...
        logger.info("Evaluation found: " + Arrays.toString(evaluation.getRubriqueEvaluations().toArray()));
